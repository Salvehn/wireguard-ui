...
Можно добавить несколько туннелей и управлять каждым отдельно. Настройки доступны через **Редактировать**, а управление подключением — также через значок приложения в строке меню.
